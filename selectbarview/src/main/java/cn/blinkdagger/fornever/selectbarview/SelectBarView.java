...
public class SelectBarView extends View {
    ...
    public SelectBarView(Context context, AttributeSet attrs) {
        ...
        borderColor = a.getColor(R.styleable.SelectBarView_borderColor, Color.parseColor("#333333"));
        ...
        bgColor = a.getColor(R.styleable.SelectBarView_bgColor, Color.parseColor("#333333"));
        checkedBgColor = a.getColor(R.styleable.SelectBarView_checkedBgColor, Color.parseColor("#333333"));
        textColor = a.getColor(R.styleable.SelectBarView_textColor, Color.parseColor("#333333"));
        checkedTextColor = a.getColor(R.styleable.SelectBarView_checkedTextColor, Color.parseColor("#333333"));
        ...
        splitLineColor = a.getColor(R.styleable.SelectBarView_splitLineColor, Color.parseColor("#333333"));
        splitLineWidth = a.getDimension(R.styleable.SelectBarView_splitLineWidth, 1);
        dotColor = a.getColor(R.styleable.SelectBarView_dotColor, Color.parseColor("#333333"));
    ...
    public void setItemChecked(@IntRange(from = 0) int checkedIndex) {
        if(items.length == 0){
            ...
            for (int i = 0; i < items.length; i++) {
                ...
                if (xInField && checkedIndex != i) {
                    ...
                    if (itemClickListener != null) {
                        itemClickListener.onItemChecked(i);
                    }
                }
            }
        }
